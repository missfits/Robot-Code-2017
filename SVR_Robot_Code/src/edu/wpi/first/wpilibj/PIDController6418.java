 ...
 */
public class PIDController6418 implements PIDInterface, LiveWindowSendable, Controller {
  ...
  private class PIDTask extends TimerTask {
    ...
    private PIDController6418 m_controller;

    public PIDTask(PIDController6418 pidController6418) {
      if (pidController6418 == null) {
        throw new NullPointerException("Given PIDController was null");
      }
      m_controller = pidController6418;
    }
  ...
  public PIDController6418(double Kp, double Ki, double Kd, double Kf, PIDSource source,
   ...
   */
  @SuppressWarnings("ParameterName")
  public PIDController6418(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output,
                       double period) {
  ...
  //   System.out.println("pidInput value: " + input + " setPoint value: " + m_setpoint);
      synchronized (this) {
 ...
 //     System.out.println("pidWrite to motor: " + result + "\terror " + m_error);
 //     System.out.println("");
